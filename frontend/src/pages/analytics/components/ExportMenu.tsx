...
export function ExportMenu({
  ...
  holidayStats: HolidayAwareAttendanceStats;
}) {
  ...
  function exportAssessments() {
    const rows = [
      ...dashboard.exams_attempted,
      ...dashboard.quizzes_attempted,
    ].map((a) => ({
    ...
    const rows = [
      {
        ...
        value: a.overall.average_percentage,
        trend: a.overall.trend,
      },
      {
        metric: "Exam average %",
        value: a.exams.average_percentage,
        trend: a.exams.trend,
      },
      {
        metric: "Quiz average %",
        value: a.quizzes.average_percentage,
        trend: a.quizzes.trend,
      },
      {
        metric: "Attendance sessions",
        value: a.attendance.total_sessions,
        trend: a.attendance.trend,
      },
      {
        metric: "Attendance rate (30d, excl. library holidays) %",
        value: holidayStats.ratePercent,
        trend: "",
      },
      {
        metric: "Current streak, excl. holidays (days)",
        value: holidayStats.streakDays,
        trend: "",
      },
      {
        metric: "Digital library sessions",
        value: a.digital_library.total_sessions,
        trend: "",
      },
      {
        metric: "Offline library sessions",
        value: a.offline_library.total_sessions,
        trend: "",
      },
    ];
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-light">
                Full report, browser print dialog
              </p>
            </div>
          </button>
