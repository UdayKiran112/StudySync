...
const baseFieldClasses =
  "w-full rounded-md border border-border bg-card px-3 py-2 text-sm text-ink placeholder:text-slate-light transition-colors duration-150 focus:border-brass focus:outline-none disabled:bg-paper-dim disabled:text-slate-light";
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={clsx(baseFieldClasses, "resize-none", className)}
    {...props}
  />
));
