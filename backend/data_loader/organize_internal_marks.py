...
with open(OUT, "w", newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
    writer.writerow(["Sl.No", "ID", "Name of Student", "Date of Exam", "Name of Exam", "Marks Obtained", "Max Marks"])
    for i, r in enumerate(rows_out, start=1):
        writer.writerow([i, r["id"], r["name"], r["date"], r["exam"], r["marks"], r["max_marks"]])
